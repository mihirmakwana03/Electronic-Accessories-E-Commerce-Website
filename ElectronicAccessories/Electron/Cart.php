...
$qry = "SELECT * FROM `products` WHERE P_id = '$_SESSION[CP_id]' ";

$result = mysqli_query($cn, $qry);

$row = mysqli_fetch_row($result);

$_SESSION['CP_id'] = $row[0];
$_SESSION['CP_img'] = $row[1];
$_SESSION['CP_name'] = $row[2];
$_SESSION['CP_Price'] = $row[3];
...
<center>
        ...
        <table border=\"1\">
        <tr><td id='bb'> <img src='" . $_SESSION['CP_img'] . "' class='Pimg'> </td>
        
        <td id='bb'>" . $_SESSION['CP_name'] . "
        <br><div> Price: <sup>&#x20B9;</sup>" . $_SESSION['CP_Price'] . "</div><br>
         </td></tr>
        </table><br>
        </center>
...
<body>
    ...
    <table width="30%" id="table1" cellpadding="5" align="center">
        ...
        <tr id="tr">
            <form action="http://localhost/ElectronicAccessories/Electron/Cart2.php" name="frm" method="post">
